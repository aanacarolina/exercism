...
(deftest withdrawal-test
  ...
  (is (thrown-with-msg? ExceptionInfo #"Insuficient funds" (bank/withdrawal {:accounts {0 {:balance 10 :status "open"}}} 0 25))))
...
(deftest close-account-balance-test
  ...
  (is (thrown-with-msg? ExceptionInfo #"Balance is not zero" (bank/close-account-balance {:accounts {0 {:balance 10 :status "open"} 1 {:balance 15 :status "open"}}} 1 )) ))